...
const Hero = () => {
    return (
        <div className="conatiner mt-9">
            <div className="flex flex-col gap-10 sm:gap-0 md:flex-row items-center container">

                <div className="flex-1 sm:ml-10 lg:ml-0 lg:mt-0 mt-10 container text-center">
                    <div className="max-w-xl">
                        <h1 className="text-black text-3xl sm:text-5xl md:text-5xl font-sans lg:text-6xl font-extrabold tracking-tighter">
                            {/* Namaste, India!  */}
                            Salam, UAE!
                            <br />
